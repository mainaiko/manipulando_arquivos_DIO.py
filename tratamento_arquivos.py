...
filenotfounderror: lançada quando o arquivo que esta sendo aberto nao pode ser encontrado no
diretorio especificado

permissionerrror: lançada quando ocorre uma tentativa de abrir um arquivo sem permissoes adequadas
para leitura ou gravaçao

IOerror: lançada quando ocorre um erro geral de E/s (entrada e saida) ao trabalhar com o arquivo
